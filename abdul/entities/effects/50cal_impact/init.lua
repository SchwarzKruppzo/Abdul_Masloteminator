...
self.Emitter 		= ParticleEmitter( self.Pos )	// Emitter must be there so you don't get an error			//
	if GetConVar("abdulgraphic_impact"):GetInt() == 0 then
		return
	elseif GetConVar("abdulgraphic_impact"):GetInt() == 2 then
		self.Scale = data:GetScale()/1.5
	elseif GetConVar("abdulgraphic_impact"):GetInt() == 1 then
		self.Scale = data:GetScale()/2
	end
